...
"""autogenerated by genpy from kimera_interfacer/SyncSemanticRaw.msg. Do not edit."""
import codecs
import sys
...
class SyncSemanticRaw(genpy.Message):
  _md5sum = "06521f7c2a5c6fea82ae6a53446fde98"
  _type = "kimera_interfacer/SyncSemanticRaw"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SyncSemanticRaw, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.depth is None:
        self.depth = sensor_msgs.msg.Image()
      if self.sem is None:
        self.sem = sensor_msgs.msg.Image()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.sem.header.seq, _x.sem.header.stamp.secs, _x.sem.header.stamp.nsecs))
      _x = self.sem.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.sem.height, _x.sem.width))
      _x = self.sem.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.sem.is_bigendian, _x.sem.step))
      _x = self.sem.data
      length = len(_x)
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sem.header.seq, _x.sem.header.stamp.secs, _x.sem.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.sem.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.sem.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.sem.height, _x.sem.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.sem.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.sem.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.sem.is_bigendian, _x.sem.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.sem.data = str[start:end]
      _x = self
      start = end
      end += 12
