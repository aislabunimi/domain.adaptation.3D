...
class SAM2RefinerMixed:
    def __init__(self, model_path: str = "sam2_b.pt", visualize: bool = True, skip_labels: list = None,
                 batch_size: int = 8, fill_strategy: str = "maxlabel"):
        """
        ...
        Args:
            ...
            fill_strategy (str): Strategy for unlabeled regions: 'maxlabel' or 'ereditary'.
        """
    ...
    def refine(self, image: np.ndarray, mask: np.ndarray) -> np.ndarray:
        ...
        # Step 3: Fill missed areas — two strategies: maxlabel (default) or ereditary
        ...
        if self.fill_strategy == "maxlabel":
            ...
            # Simply restore the original pseudolabels wherever the refinement failed
