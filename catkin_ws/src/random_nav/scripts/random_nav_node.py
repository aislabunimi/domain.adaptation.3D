...
from random_nav.msg import Sensors
...
class RandomNavigator:
    def __init__(self):
        ...
        rospy.Subscriber("/habitat/scene/sensors", Sensors, self.images_callback)
    ...
    def images_callback(self, msg):
        ...
        self.current_rgb = PILBridge.rosimg_to_numpy(msg.rgb)

        self.current_depth = PILBridge.rosimg_to_numpy(msg.depth)
