...
from data_loaders.utils.scannet_ngp_full_scene import ScanNetNGPFullScene


class FineTuneDataModuleFullScene(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        self.scannet_test_validation = ScanNetNGPFullScene(
        ...
        self.scannet_test_gen = ScanNetNGPFullScene(
            root=self.dataset_path,
            mode="val",  # val
            deeplab=self.deeplab,
            pseudo3d=self.pseudo3d,
        ...
        self.scannet_train = ScanNetNGPFullScene(
            root=self.dataset_path,
            mode="train",  # val
