...
from data_loaders.utils.scannet_ngp_both_method import ScanNetNGPBothMethod
from utils.loading import sanitize_split_file
from utils.paths import DATASET_PATH, REPO_ROOT


class FineTuneDataModuleBothMethod(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        self.scannet_test_validation = ScanNetNGPBothMethod(
        ...
        self.scannet_test_gen = ScanNetNGPBothMethod(
            root=self.dataset_path,
            mode="val",  # val
            deeplab=self.deeplab,
            pseudo3d=self.pseudo3d,
        ...
        self.scannet_train = ScanNetNGPBothMethod(
            root=self.dataset_path,
            mode="train",  # val
